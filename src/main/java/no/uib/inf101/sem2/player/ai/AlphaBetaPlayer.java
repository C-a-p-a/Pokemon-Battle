package no.uib.inf101.sem2.player.ai;

import no.uib.inf101.grid.Move;
import no.uib.inf101.sem2.game.Game;
import no.uib.inf101.sem2.player.AbstractPlayer;
 ...
 * <p>
 * This player uses a minimax strategy to search for the best move, with
 * AlphaBeta pruning.
 ...
 * One can define their own score method in the respective games to better
 * evaluate
